...
public class gps_tracker_view_map extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.gps_tracker_view_map);
        ...
        final pafap_db dbmap = new pafap_db(this);
        sms = dbmap.getLastLogByUid(Integer.parseInt(uid));
    ...
    public void trackMarker(GoogleMap mMap, String title, double lat, double lng){
        MarkerOptions trackermarker = new MarkerOptions().position(new LatLng(lat, lng)).title(title);
        mMap.addMarker(trackermarker);
    }
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        // Add a marker in Tirana and move the camera
